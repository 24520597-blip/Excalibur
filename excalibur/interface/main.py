#!/usr/bin/env python3
"""Main CLI entry point for Excalibur."""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog="excalibur",
        description="Excalibur - AI-Powered CTF Challenge Solver",
...
Examples:
  ...
  # Web challenge
  excalibur --target https://ctf.example.com/challenge1

  # With challenge context/hints
  excalibur --target 10.10.11.100 --instruction "Wordpress site, focus on plugin vulnerabilities"

  # Non-interactive mode
  excalibur --target challenge.htb --non-interactive
...
def print_banner() -> None:
    ...
    banner.append("Excalibur", style="bold #6366f1")
...
async def run_cli_mode(args: argparse.Namespace) -> None:
    ...
    from excalibur.core.agent import run_pentest
...
async def run_tui_mode(args: argparse.Namespace) -> None:
    ...
    from excalibur.core.session import SessionStore
    from excalibur.interface.tui import run_tui
...
def main() -> None:
    ...
    from excalibur.core.langfuse import init_langfuse, shutdown_langfuse
