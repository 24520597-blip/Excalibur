"""Enhanced Claude Code agent with tracer integration for Excalibur."""
...
DEBUG_LOG_WORKSPACE = Path("/workspace/excalibur-debug.log")
DEBUG_LOG_FALLBACK = Path("/tmp/excalibur-debug.log")
